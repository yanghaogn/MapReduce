...
public class WholeFileRecordReader extends RecordReader<Text, Text> {
  ...
  public void initialize(InputSplit genericSplit,
    ...
    this.maxLineLength = job.getInt("mapred.WholeFileRecordReader.maxlength",
                                    Integer.MAX_VALUE);
    ...
    key.set(split.getPath().toString());//set key
  ...
  public boolean nextKeyValue() throws IOException {
    ...
    while (getFilePosition() <= end) {
      ...
      if(0==content.length()) content.append(line);
    ...
    if(0==content.length()) return false;//标识结束
     return true;
  }
