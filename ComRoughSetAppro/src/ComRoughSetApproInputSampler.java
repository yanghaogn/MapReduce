...
public class ComRoughSetApproInputSampler<K,V> extends Configured implements Tool  {

  private static final Log LOG = LogFactory.getLog(ComRoughSetApproInputSampler.class);
  ...
  public ComRoughSetApproInputSampler(Configuration conf) {
    setConf(conf);
  }
  ...
  public static void main(String[] args) throws Exception {
	ComRoughSetApproInputSampler<?,?> sampler = new ComRoughSetApproInputSampler(new Configuration());
